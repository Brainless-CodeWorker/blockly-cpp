...
Blockly.Blocks.lists_getIndex = {
    init: function () {
        ...
        this.setTooltip(function () {
            var a =
                b.getFieldValue("MODE"), e = b.getFieldValue("WHERE"), d = "";
            switch (a + " " + e) {
                case "GET FROM_START":
                case "GET FROM_END":
...
Blockly.Blocks.procedures_defnoreturn = {
    init: function () {
        ...
        for (var c = 0; c < this.argumentVarModels_.length; c++) {
            var e = document.createElement("arg"), d = this.argumentVarModels_[c];
        ...
        for (var b = 0, c; c =
            ...
            e = Blockly.Variables.getOrCreateVariablePackage(this.workspace, c, e, "");
        ...
        if ("" == c.type) {
            c = c.name;
            for (var e = this.workspace.getVariableById(b), d = !1, f = 0; f < this.argumentVarModels_.length; f++) this.argumentVarModels_[f].getId() == a && (this.arguments_[f] =
                e.name, this.argumentVarModels_[f] = e, d = !0);
            d && this.displayRenamedVar_(c, e.name)
        }
    }, updateVarName: function (a) {
        for (var b = a.name, c = !1, e = 0; e < this.argumentVarModels_.length; e++) if (this.argumentVarModels_[e].getId() == a.getId()) {
        ...
        this.updateParams_();
        if (this.mutator.isVisible()) for (var c = this.mutator.workspace_.getAllBlocks(), e = 0, d; d = c[e]; e++) "procedures_mutatorarg" == d.type && Blockly.Names.equals(a,
            d.getFieldValue("NAME")) && d.setFieldValue(b, "NAME")
    }, customContextMenu: function (a) {
        if (!this.isInFlyout) {
            ...
            for (var d = 0; d < this.arguments_.length; d++) c = document.createElement("arg"), c.setAttribute("name", this.arguments_[d]), e.appendChild(c);
            c = document.createElement("block");
...
Blockly.Blocks.procedures_callnoreturn = {
    init: function () {
        ...
        if (b) if (a.join("\n") == this.arguments_.join("\n")) this.quarkIds_ = b; else {
            ...
            this.argumentVarModels_ = [];
            for (d = 0; d < this.arguments_.length; d++) e = Blockly.Variables.getOrCreateVariablePackage(this.workspace,
                null, this.arguments_[d], ""), this.argumentVarModels_.push(e);
            this.updateShape_();
...
Blockly.Constants.Text.QUOTE_IMAGE_MIXIN = {
    ...
    quoteField_: function (a) {
        for (var b = 0, c; c = this.inputList[b]; b++) for (var e = 0, d; d = c.fieldRow[e]; e++) if (a == d.name) {
...
Blockly.Constants.Variables.CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN = {
    customContextMenu: function (a) {
        if (!this.isInFlyout) {
            ...
            var e = {enabled: 0 < this.workspace.remainingCapacity()}, d = this.getField("VAR").getText();
