    ...
    goog.TransformedDependency.prototype.load = function (a) {
        ...
        if (goog.global.CLOSURE_IMPORT_SCRIPT) b(), this.contents_ && goog.global.CLOSURE_IMPORT_SCRIPT("", this.contents_) ? (this.contents_ = null, a.loaded()) : a.pause(); else {
            var f = this.loadFlags.module ==
                goog.ModuleType.ES6, g = 1 < a.pending().length, h = g && goog.DebugLoader_.IS_OLD_IE_;
...
Blockly.VariableMap.prototype.renameVariable = function (a, b) {
    var c = this.getVariable(b, a.type), d = this.workspace.getAllBlocks();
...
Blockly.Xml.workspaceToDom = function (a, b) {
    var c = goog.dom.createDom("xml"), d = Blockly.Xml.variablesToDom(Blockly.Variables.allUsedVarModels(a));
...
Blockly.ZoomControls.prototype.createZoomOutSvg_ = function (a) {
    var b = this.workspace_,
        c = Blockly.utils.createSvgElement("clipPath", {id: "blocklyZoomoutClipPath" + a}, this.svgGroup_);
...
Blockly.ZoomControls.prototype.createZoomInSvg_ = function (a) {
    var b = this.workspace_,
        c = Blockly.utils.createSvgElement("clipPath", {id: "blocklyZoominClipPath" + a}, this.svgGroup_);
...
Blockly.ZoomControls.prototype.createZoomResetSvg_ = function (a) {
    var b = this.workspace_,
        c = Blockly.utils.createSvgElement("clipPath", {id: "blocklyZoomresetClipPath" + a}, this.svgGroup_);
    ...
    b.readOnly || b.hasScrollbars || e.addChangeListener(function () {
        if (!e.isDragging()) {
            ...
            if (a.contentTop < d || a.contentTop +
                a.contentHeight > a.viewHeight + d || a.contentLeft < (b.RTL ? a.viewLeft : c) || a.contentLeft + a.contentWidth > (b.RTL ? a.viewWidth : a.viewWidth + c)) for (var k = e.getTopBlocks(!1), l = 0, n; n = k[l]; l++) {
                var m = n.getRelativeToSurfaceXY(), p = n.getHeightWidth(), q = d + 25 - p.height - m.y;
                0 < q && n.moveBy(0, q);
